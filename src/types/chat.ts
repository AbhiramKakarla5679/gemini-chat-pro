...
export const AVAILABLE_MODELS: ModelOption[] = [
  { id: 'openai/gpt-5-nano', name: 'GPT-5 Nano', description: 'Fast and efficient for everyday tasks', category: 'gpt' },
  { id: 'google/gemini-3-pro-preview', name: 'Gemini 3 Pro', description: 'Most capable model for complex tasks', category: 'gemini' },
  { id: 'google/gemini-3-flash-preview', name: 'Gemini 3 Flash', description: 'Fast and balanced performance', category: 'gemini' },
